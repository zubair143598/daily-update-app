        ...
        <div className="py-12 md:py-20">
          ...
          <div className="text-center">
            ...
            <div data-aos="fade-up" data-aos-delay={400} data-aos-offset="0" data-aos-anchor-placement="top-bottom">
              <Link
                className="btn group mb-4 bg-gradient-to-t from-forest-600 to-forest-500 hover:brightness-50 hover:transition-all hover:duration-150 bg-[length:100%_100%] bg-[bottom] text-white shadow-[inset_0px_1px_0px_0px_theme(colors.white/.16)] hover:bg-[length:100%_150%] sm:mb-0 w-auto rounded-full px-16 mt-8"
