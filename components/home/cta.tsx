  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6">
        <div className="bg-gradient-to-r from-[rgba(5,5,5,0.5)] via-forest-800/10 to-[rgba(5,5,5,0.5)] pt-12 md:pb-7 md:pt-20">
          <div className="mx-auto max-w-3xl text-center">
            <h2
              ...
              data-aos="fade-up"
            >
              Let’s Build Your <br className="sm:hidden block"/>Vision Together
            </h2>
            <p className="text-forest-200/65 text-[16px] font-normal md:text-[18px] font-raleway mb-4">
