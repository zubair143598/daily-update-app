  ...
  return (
    <footer className="mt-12">
      ...
      <div className="relative flex justify-center w-full overflow-hidden h-56">
        ...
        <div className="absolute bottom-0 left-0 flex justify-center w-full my-auto md:h-full">
          <Image
            src={"/logo.svg"}
            width={350}
            height={-1}
      ...
      {/* <div className="relative flex justify-center w-full overflow-hidden h-56">
        <Image
          ...
          className="object-cover object-center h-full opacity-40"
        />
         <div className="absolute md:bottom-0 top-4 md:top-0 left-4 flex sm:justify-normal justify-center sm:items-center w-full  my-auto h-full">
         <ul className="inline-flex gap-1">
              <li>
                <Link
                  className="flex items-center justify-center text-forest-500 transition hover:text-forest-400"
        ...
        <div className="absolute bottom-0 left-0 flex justify-center w-full my-auto h-full">
          <Image src={'/logo.svg'} width={350} height={-1} alt="Footer logo" className="object-center" /> 
        </div>
        <div className="absolute bottom-4 sm:bottom-0 right-4 flex justify-center  sm:items-center w-full sm:w-auto my-auto sm:h-full">
        <p className="font-raleway text-xl text-white">Copyright  ® Lumunate 2024</p> 
        </div>
      </div> */}
    </footer>
